...
type CustomerHistoryOrder = Pick<SubmittedOrder, "id" | "status" | "orderType" | "customerName" | "totalAmount"> & { createdAt: string | Date; updatedAt: string | Date };
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    setCheckoutPhone(customerAuth.phone.replace(/^\+963/, ""));
...
function CustomerAccountScreen({ session, orders, onBack, onLogout, onPhoneSubmit, savingPhone, onOpenOrder }: { session: CustomerAuthSession; orders: CustomerHistoryOrder[]; onBack: () => void; onLogout: () => void; onPhoneSubmit: (phone: string) => void; savingPhone: boolean; onOpenOrder?: () => void }) {
