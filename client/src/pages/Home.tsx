...
export default function Home() {
  ...
  return (
    <main dir="rtl" className="lahza-app-shell min-h-screen text-slate-950">
      ...
      {screen !== "home" && screen !== "store" && screen !== "productQuantity" && screen !== "storeOffers" && screen !== "checkout" ? <div className="global-offer-bar"><PartnerOfferGallery slides={partnerGallerySlides} onOpen={openFeaturedOffers} /></div> : null}
      ...
      <EntryGateDialog open={entryOpen} onChoose={role => { if (role === "guest") { setEntryOpen(false); return; } setEntryOpen(false); setSecretRole(role); setSecretOpen(true); }} />
