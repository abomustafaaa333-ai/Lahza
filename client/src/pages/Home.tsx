...
export default function Home() {
  ...
  const submitCheckout = async () => {
    ...
    if (isWosselLi && (!/^\+9639\d{8}$/.test(wosselPickupContactPhone) || !wosselItemDescription.trim() || !deliveryAddress.trim())) {
      toast.error("أدخل رقم جهة الاستلام السوري، ونوع الغرض، وعنوان التسليم");
      return;
    }
    ...
    createOrder.mutate({
      ...
      pickupLocation: isTaxi ? pickup : isWosselLi ? "يتم تحديد مكان الاستلام هاتفياً مع جهة الاستلام" : undefined,
