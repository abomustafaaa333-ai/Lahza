...
function CustomerAuthScreen({ onAuthenticated, onStaffLogin }: { onAuthenticated: (session: CustomerAuthSession) => void; onStaffLogin: (phone: string, role: "owner" | "supervisor" | "partner", password: string) => void }) {
  ...
  const [staffRole, setStaffRole] = useState<"owner" | "supervisor" | "partner" | null>(null);
