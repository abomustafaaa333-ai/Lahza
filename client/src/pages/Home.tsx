        ...
        <>
          <section className="app-shell pb-10">
            ...
            <div className="home-category-row" aria-label="أقسام لحظة">
              <button type="button" className="home-category-card home-category-all" onClick={() => setScreen("delivery")}><span className="home-category-mini-grid" aria-hidden="true"><span><UtensilsCrossed /></span><span><ShoppingBasket /></span><span><Store /></span><span><Pill /></span></span><span>الكل</span></button>
