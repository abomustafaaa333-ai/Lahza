        ...
        <>
          ...
          <section className="app-shell pb-10 home-discover-section">
            ...
            <div className="home-category-row" dir="rtl" aria-label="أقسام لحظة">
              ...
              {selectedCity === "jarabulus" ? <button type="button" className="home-category-card home-category-all gateway-category-card" onClick={() => setScreen("delivery")}><span className="home-category-all-grid" aria-hidden="true"><Store /><ChevronLeft /></span><span className="home-category-all-label">طلبات منبج</span></button> : null}
            </div>
