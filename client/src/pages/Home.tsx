...
function Header({ onSearch, onExplore, searchPlaceholder }: { onSearch: () => void; onExplore: () => void; searchPlaceholder: string }) {
...
export default function Home() {
  ...
  return (
    <main dir="rtl" className="lahza-app-shell min-h-screen text-slate-950" onTouchStart={handleTouchStart} onTouchMove={handleTouchMove} onTouchEnd={handleTouchEnd}>
      ...
      {screen === "home" ? <Header onSearch={() => setSearchOpen(true)} onExplore={openFeaturedOffers} searchPlaceholder={searchPlaceholder} /> : null}
