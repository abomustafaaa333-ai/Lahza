...
export default function Home() {
  ...
  const gatewayStoresQuery = trpc.lahza.storefront.gatewayStores.useQuery(undefined, { enabled: !isStaticDemo && selectedCity === "jarabulus" && gatewayMode, retry: false });
