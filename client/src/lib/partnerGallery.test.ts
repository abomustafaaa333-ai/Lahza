...
describe("معرض صور عروض الشركاء", () => {
  it("يعرض صور HTTPS الفريدة فقط ويحفظ بيانات العرض", () => {
    const slides = buildPartnerGallerySlides([
      { id: 1, name: "معمول", imageUrl: "https://images.example.com/maamoul.jpg", partnerName: "حلويات الشام", unitPrice: 30000 },
    ...
    expect(slides).toEqual([{ id: 1, name: "معمول", imageUrl: "https://images.example.com/maamoul.jpg", partnerName: "حلويات الشام", unitPrice: 30000 }]);
  });
