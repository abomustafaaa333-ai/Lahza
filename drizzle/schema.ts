...
export const catalogItems = mysqlTable("catalog_items", {
  ...
  stockInitialQuantity: int("stockInitialQuantity").notNull().default(0),
  stockAlertPercent: int("stockAlertPercent").notNull().default(20),
...
export const orders = mysqlTable("orders", {
  ...
  pharmacyPrescriptionUrl: varchar("pharmacyPrescriptionUrl", { length: 500 }),
  pharmacyPrice: int("pharmacyPrice").notNull().default(0),
  pharmacyPricingStatus: mysqlEnum("pharmacyPricingStatus", ["not_required", "pending", "priced", "expired"]).notNull().default("not_required"),
  pharmacyPricingSentAt: timestamp("pharmacyPricingSentAt"),
  pharmacyPricingReminderSentAt: timestamp("pharmacyPricingReminderSentAt"),
...
export const systemSettings = mysqlTable("system_settings", {
  ...
  manbijStorePricePerKm: int("manbijStorePricePerKm").notNull().default(2),
  manbijStoreMinutesPerKm: int("manbijStoreMinutesPerKm").notNull().default(5),
  jarabulusStorePricePerKm: int("jarabulusStorePricePerKm").notNull().default(2),
  jarabulusStoreMinutesPerKm: int("jarabulusStoreMinutesPerKm").notNull().default(5),
  jarabulusGatewayPricePerKm: int("jarabulusGatewayPricePerKm").notNull().default(2),
  jarabulusGatewayMinutesPerKm: int("jarabulusGatewayMinutesPerKm").notNull().default(15),
  wosselLiMinutesPerKm: int("wosselLiMinutesPerKm").notNull().default(5),
...
export const inventoryMovements = mysqlTable("inventory_movements", {
  ...
  reason: mysqlEnum("reason", ["purchase", "adjustment", "order_reserved", "order_released", "order_completed"]).notNull(),
